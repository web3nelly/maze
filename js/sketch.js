...
let customFrameRate;
let createMazeSpeed;
let lightRed, yellowGreen, lightGreen, darkGreen, lightBlue, gray;
let maze, aStarAI;
let pause = false;
...
function setup() {
  ...
  customFrameRate = floor(1600 / cellSize);
  ...
  // createCanvas(windowWidth - 60, windowHeight - 60); // Dynamic canvas size
  createCanvas(1200, 800);
  frameRate(customFrameRate);

  // Define colors the program will use
  lightRed = color(201, 68, 48, 300);
  yellowGreen = color(250, 250, 100, 150);
  lightGreen = color(74, 178, 101, 100);
